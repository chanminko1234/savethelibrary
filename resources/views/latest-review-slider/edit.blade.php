...
<form class="form" role="form" method="POST" action="{{ url('backend/latest-review-slider/' . $LatestReview->id) }}" enctype="multipart/form-data">
    ...
    <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
     ...
     name="book_name" value="{{$LatestReview->book_name}}">
    ...
    <input type="text" class="form-control" name="author" value="{{$LatestReview->author}}">
    ...
    <textarea name="book_description" id="summernote" cols="30" rows="10">{!! $LatestReview->book_description !!}</textarea>
    ...
    <textarea name="book_review" id="summernote2" cols="30" rows="10">{!! $LatestReview->book_review !!}</textarea>
    ...
    <input type="text" class="form-control" name="library_name" value="{{$LatestReview->library_name}}">
    ...
    <textarea class="form-control" rows="5" name="library_address">{!! $LatestReview->library_address !!}</textarea> 
    ...
    <input type="text" class="form-control" name="library_contact" value="{{$LatestReview->library_contact}}">
